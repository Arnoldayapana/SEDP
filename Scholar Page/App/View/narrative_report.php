...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO scholar_narrative_reports (report_title, submission_date, report_content, file, report_month) 
...
$submittedReports = [];
$stmt = $pdo->query("SELECT report_month FROM scholar_narrative_reports");
