<?php
$title = 'Cerificate Of Grade | SEDP HRMS';
$page = 'Complieances';
...
<div class="wrapper">
    ...
    <div class="main p-3">
        ...
        <div class="container-fluid shadow p-3 mb-2 bg-body-tertiary rounded-2">
            <h3 class="fw-bold fs-4">Cerificate Of Grade</h3>
            <hr>
            <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    FROM 
                        recipient r
                    JOIN 
                        scholar_certificate_of_grade snr
                    ON 
                        r.recipient_id = snr.recipient_id
                    WHERE 
                        snr.submission_date = (
                            SELECT MAX(submission_date)
                            FROM scholar_certificate_of_grade snr_inner
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href='../COG/viewCOG.php?id={$row['recipient_id']}' class='btn btn-warning btn-sm'>
                                    <i class='bi bi-eye'></i>
                                </a> 
                            </td>
                        </tr>";
