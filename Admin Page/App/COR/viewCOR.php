<?php
$title = 'View Student COR Report | SEDP HRMS';
$page = 'View Student COR Report';
...
$sql = "SELECT 
        ...
        FROM 
            recipient r
        JOIN 
            scholar_certificate_of_registration snr ON r.recipient_id = snr.recipient_id
        LEFT JOIN 
...
<div class="wrapper">
    ...
    <div class="main p-3">
        ...
        <div class="header d-flex">
            <h3 class="fw-bold fs-5 p-2 ms-3">Recipient COR Report</h3>
            <div class="ms-auto me-2">
                <a href="../../App/Compliances/ThesisExpenses.php" class="btn btn-dark">Return</a>
            </div>
        </div>
            ...
            <div class="container m-2 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="download.php?file=<?php echo htmlspecialchars($recipient['COR']); ?>">
