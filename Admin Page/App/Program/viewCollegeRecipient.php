...
$sql = "
    ...
    FROM recipient r
    LEFT JOIN recipientinfo ri ON r.recipient_id = ri.recipient_id
    LEFT JOIN recipientfamilybg rfbg ON r.recipient_id = rfbg.recipient_id
...
$stmt->bind_param("i", $recipient_id); // Bind a single integer parameter
    ...
    <div class="main p-3">
        ...
        <div class="header d-flex">
            ...
            <div class="ms-auto me-2">
                <a href="College.php" class="btn btn-dark"> return</a>
            </div>
        </div>
        ...
        <div class="container-fluid shadow mb-2 rounded m-2 p-2" id="container">
            <div class="row mb-4 m-2 p-2 ">
                ...
                <h1 class="fw-bold fs-5 bg-dark text-white p-2">PERSONAL INFORMATION</h1>
                <hr>
                ...
                <div class="d-flex mb-2">
                    ...
                    <div class="col-12 d-flex">
                        <div class="col-sm-6">
                            <p><span class="fw-bold">School/College/University :</span> <?php echo htmlspecialchars($scholar['School'] ?? 'No School available'); ?></p>
                        </div>
                        <div class="col-sm-6">
                ...
                <!--Family Background-->
                <h1 class="fw-bold fs-5 bg-dark text-white p-2">FAMILY BACKGROUND</h1>
                <hr>
                ...
                <h1 class="fw-bold fs-5 bg-dark text-white p-2">HOBBIES</h1>
                <hr>
