...
$totalCountSql = "SELECT COUNT(*) as total FROM scholar_applicant";
...
<div class="wrapper">
    ...
    <div class="main p-3">
        ...
        <div class="container-fluid shadow p-3 bg-body-tertiary rounded-4">
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM scholar_applicant $searchCondition LIMIT $limit OFFSET $offset";
                        $result = $connection->query($sql);
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type='button' class='btn btn-primary btn-sm' data-bs-toggle='modal'
                                 data-bs-target='#{$scholarId}' onclick='setScholarForInterview({$row['scholar_id']})'>
