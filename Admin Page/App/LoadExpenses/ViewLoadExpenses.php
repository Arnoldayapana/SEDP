...
$sql = "SELECT 
            ...
            sle.submission_date   -- Assuming you want the submission date from the 'scholar_narrative_reports' table
        FROM 
            recipient r
        JOIN 
            scholar_narrative_reports sle
        ON 
    ...
    <div class="main p-3">
        ...
        <div class="header d-flex">
            ...
            <div class="ms-auto me-2">
                <a href="../../App/Compliances/LoadExpenses.php" class="btn btn-dark">Return</a>
            </div>
        </div>
